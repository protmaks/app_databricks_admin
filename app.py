...
menu = {
    ...
    "Compute": [
        ...
        st.Page("menu/compute_allpurp.py", title="All-Purpose compute", icon=":material/desktop_windows:",        ),
        st.Page("menu/compute_jobs_runs.py", title="Job runs", icon=":material/check_circle:",),
        st.Page("menu/compute_sqlwh.py", title="SQL warehouses", icon=":material/cloud:"),
        st.Page("menu/compute_apps.py", title="Apps", icon=":material/apps:"),
        st.Page("menu/compute_lakebase.py", title="Lakebase", icon=":material/apps:"), 
    ],
    "Compute Monitoring": [
        st.Page("menu/monitoring_allpurp_timeline.py", title="All-Purpose Daily Runs", icon=":material/timeline:",),
        st.Page("menu/jobs_in_allpurp_cluster.py", title="Jobs in All-purp Cluster", icon=":material/memory:",),
    ],
    "Jobs": [
        st.Page("menu/jobs_settings.py", title="Job Settings", icon=":material/check_circle:",),
